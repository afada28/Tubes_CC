...
@section('page-title', 'Add Carousel Item')
                    ...
                    <div class="mb-4 p-4 border rounded" style="background-color: #f8f9fa;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title_1') is-invalid @enderror"
                                id="title_1" name="title_1" value="{{ old('title_1') }}">
                            @error('title_1')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content_1') is-invalid @enderror"
                                id="content_1" name="content_1" rows="3">{{ old('content_1') }}</textarea>
                            @error('content_1')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 p-4 border rounded" style="background-color: #f8f9fa;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title_2') is-invalid @enderror"
                                id="title_2" name="title_2" value="{{ old('title_2') }}">
                            @error('title_2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content_2') is-invalid @enderror"
                                id="content_2" name="content_2" rows="3">{{ old('content_2') }}</textarea>
                            @error('content_2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 p-4 border rounded" style="background-color: #f8f9fa;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title_3') is-invalid @enderror"
                                id="title_3" name="title_3" value="{{ old('title_3') }}">
                            @error('title_3')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content_3') is-invalid @enderror"
                                id="content_3" name="content_3" rows="3">{{ old('content_3') }}</textarea>
                            @error('content_3')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
